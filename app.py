...
model = pickle.load(open('artifacts/nn_model.pkl', 'rb'))
book_names = pickle.load(open('artifacts/nn_book_names.pkl', 'rb'))
final_rating = pickle.load(open('artifacts/nn_final_rating.pkl', 'rb'))
book_pivot = pickle.load(open('artifacts/nn_book_pivot.pkl', 'rb'))
